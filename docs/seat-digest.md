...
- `any` · `any` · **The `stale-wall` advisory cannot be cleared by doing what it asks. Re-verify anyway — but do not expect the warning to go away, and do not "fix" it…
- …plus 13 more — read `docs/CAPABILITIES.md`.
