...
- `any` · `any` · **CORRECTION to this morning's own entry: "403 on every path" was right in conclusion and sloppy in evidence — I never checked the environment, which…
- …plus 14 more — read `docs/CAPABILITIES.md`.
