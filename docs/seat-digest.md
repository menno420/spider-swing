...
- `any` · `owner-live` · **HUD text in gameplay footage cannot be read by template matching in this seat; frames must be read visually.** · evidence: glyph segmentation…
- …plus 7 more — read `docs/CAPABILITIES.md`.
