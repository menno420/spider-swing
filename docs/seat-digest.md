...
- `any` · `owner-live` · **The requested `app_block` and a music- generation tool are not exposed in this seat.** · evidence: the exact callable registry was filtered…
- …plus 4 more — read `docs/CAPABILITIES.md`.
