...
const BUILD_VERSION := "0.24.0-environment-finish-playtest"
const ANDROID_VERSION_CODE := 43
const ANDROID_APP_NAME := "Spider Swing Environment Finish Playtest (dev)"
...
const EXPECTED_CHECK_COUNT := 175
