...
const PARAMETERS := [
	...
	},
	{
		...
		"category": CATEGORY_MOVEMENT,
		"label": "Forward drive",
		"help": "Continuous forward speed recovery; zero means every gain is earned.",
		"format": &"number",
		"minimum": 0.0,
		"maximum": 1000.0,
		"step": 25.0,
		"quick": [0.0, 235.0, 470.0, 570.0],
	},
	{
		"id": &"web_range",
		"category": CATEGORY_MOVEMENT,
	...
	},
	{
		...
		"help": "Distance where maximum speed is finally reached; default is 10,000 m.",
		"format": &"meters",
		"minimum": 20000.0,
		"maximum": 250000.0,
		"step": 5000.0,
		"quick": [50000.0, 100000.0, 150000.0, 250000.0],
	},
	{
		"id": &"overspeed_pullback",
		"category": CATEGORY_MOVEMENT,
		"label": "Overspeed pull-back",
		"help": "How hard speed above the cap is corrected. Zero removes the "
	...
	},
	{
		"id": &"bird_speed",
		"category": CATEGORY_PACING,
		"label": "Bird start speed",
		"help": "World speed of the pursuer; zero turns its visual and contact off.",
		"format": &"speed",
		"minimum": 0.0,
		"maximum": 900.0,
		"step": 20.0,
		"quick": [0.0, 240.0, 300.0, 380.0],
	},
	{
		"id": &"bird_acceleration",
		"category": CATEGORY_PACING,
		"label": "Bird distance gain",
		"help": "Extra pursuer speed gained per 1,000 m of progress.",
		"format": &"speed_gain",
		"minimum": 0.0,
		"maximum": 100.0,
		"step": 2.0,
		"quick": [0.0, 8.0, 12.0, 20.0],
	},
	{
		"id": &"reel_rate",
	...
	},
	{
		...
		"help": "Type meters and tap GO, or use a preset; the test awards nothing.",
		"format": &"meters",
		"minimum": 0.0,
		"maximum": 1000000.0,
		"step": 1000.0,
	...
	{
		"id": &"bird_start_offset",
		"category": CATEGORY_RUN,
		"label": "Bird start gap",
		"help": "Opening distance from the spider to the bird's contact point.",
		"format": &"pixels",
		"minimum": 300.0,
		"maximum": 1600.0,
		"step": 40.0,
